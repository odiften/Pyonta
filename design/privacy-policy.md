...
The current version of Pyonta does not include in-app purchases, subscriptions, or third-party purchase management SDKs such as RevenueCat. If paid features are introduced in a future version, this policy will be updated before that version is released.
...
現在の Pyonta には、アプリ内課金、サブスクリプション、RevenueCat などの第三者購入管理 SDK は含まれていません。将来のバージョンで有料機能を導入する場合は、そのバージョンの公開前に本ポリシーを更新します。
